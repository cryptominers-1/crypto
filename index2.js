...
/* Chart-js (#lineChart1) */
	...
	gradientStroke1.addColorStop(0, 'rgba(0, 123, 255 ,0.3)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgba(22, 189, 60,0.3)');
	...
	gradientStroke1.addColorStop(0, 'rgba(0, 123, 255 ,0.8)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 300);
	gradientStroke2.addColorStop(0, 'rgba(22, 189, 60,0.8)');
	var myChart = new Chart(myCanvas, {
		type: 'bar',
		data: {
